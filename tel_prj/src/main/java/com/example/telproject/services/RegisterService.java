...
public class RegisterService {
    ...
    public User createUser(Map<String,String> allParams) throws Exception{
        ...
        System.out.println(passwordEncoder.encode(allParams.get("password") ) );
        User new_user= new User(allParams.get("email"),allParams.get("username"),allParams.get("firstname"),allParams.get("lastname"),passwordEncoder.encode(allParams.get("password") ));
